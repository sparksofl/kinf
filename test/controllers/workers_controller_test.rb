...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post workers_url, params: { worker: { exp_month: @worker.exp_month, salary: @worker.salary } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { exp_month: @worker.exp_month, salary: @worker.salary } }
