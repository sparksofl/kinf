...
class JournalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journal" do
    assert_difference('Journal.count') do
      post journals_url, params: { journal: { created_at: @journal.created_at, info: @journal.info, title: @journal.title } }
    end
  ...
  test "should update journal" do
    patch journal_url(@journal), params: { journal: { created_at: @journal.created_at, info: @journal.info, title: @journal.title } }
